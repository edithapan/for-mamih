  ...
  <body class="justify-center flex">
    ...
    >
      ...
      <div class="lh-1 text-center mt-4">
        ...
        <h2 class="title text-red-400 text-xl font-semibold">
          Hei MAMIH ADISS KU SAYANGG,
        </h2>
        <!-- ganti pertanyaan -->
        <p class="title question fs-1 text-2xl font-bold text-gray-700">Mamih masih berantakan mood-nya ya? Maaf ya mih kalau aku terus bikin masalah
             aku juga minta maaf karena belum peka sama perasaan mamih.
             Mamih jangan bete terus yaaa 
             jujur aku sedih banget lihat mamih kayak gitu 🥺
            jadi mamih g bete lagi kan? mamih mau maafin akuuu kan?</p>
      </div>
      ...
      <div class="numbers hidden mt-5 flex justify-center">
        <!-- ganti link -->
        <a
          href="https://wa.me/6281370234642"
          type="button"
    ...
    <script>
      ...
      function generateMessage(count) {
        const messages = ["no", "eumm,click yes mamih", "ihhhh", "klik yes", "huftt..", "<--"];
